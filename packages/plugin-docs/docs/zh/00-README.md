...
| **选插件的几张图**（哪个文件管哪：图标栏剪影 / 市场身份图 / README 封面） | [06-plugin.json规范 §marketIcon](06-plugin.json规范.md) | → [17-区域地图 三图模型](17-区域地图.md) |
| **README 里放图/视频**（市场详情页说明区显示什么） | [12-README说明区媒体契约](12-README说明区媒体契约.md) | — |
