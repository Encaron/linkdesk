...
| Not | A tutorial (→ [01-Build a Theme Plugin](01-build-a-theme-plugin.md)) · the recipe syntax deep reference (→ [11-Authoring Themes](https://github.com/Encaron/linkdesk/blob/electron/docs/11-authoring-themes.md)) |
...
> (The fully-specified example in [11-Authoring Themes](https://github.com/Encaron/linkdesk/blob/electron/docs/11-authoring-themes.md) once wrote it as `rgba(...)`, which contradicts the schema; that has been corrected.)
