---
name: gpt-taste
description: Elite UX/UI & Advanced GSAP Motion Engineer. Enforces Python-driven true randomization for layout variance, strict AIDA page structure, wide editorial typography (bans 6-line wraps), gapless bento grids, strict GSAP ScrollTriggers (pinning, stacking, scrubbing), inline micro-images, and massive section spacing. 中文触发：Awwwards 级、惊艳动效、GSAP、滚动动画、bento 网格、大幅留白、大字号编辑排版、landing 页设计、页面设计。壳 UI 也可参与竞标（池/标题栏/主题系统）——ui-ux-pro-max 仍为默认基线拿设计系统，本 skill 作风格方向竞标。
---
