...
export const REGISTERED = [
  {
    file: "src/pool/floating/quick-pick/QuickPickHost.css",
    prop: "padding-left",
    value: 14,
    why:
      "1.28 门禁修好当天翻出的存量（判据此前只看三个短手属性 ⇒ 它一直在射程外）。" +
      "⚠️ 改这个像素 = 视觉变更，硬约束 16 要求先过设计 skill、且要走软件版本 bump ⇒ " +
      "**像素裁决归 1.28b**（含姊妹视图先例：mockup 的 14px 在 AboutView / ReleaseNotesPoolView 已被拧成 16px）。" +
      "本轮只把门禁修到能看见它，并在此挂账（每次运行打印、过期即红）。",
  },
];
