...
| Not | An API reference (→ [01-plugin-api-contract](01-plugin-api-contract.md) + [the plugin-sdk README cheatsheet](https://github.com/Encaron/linkdesk/blob/electron/packages/plugin-sdk/README.md#api-速查表)) · a field dictionary (→ [06-plugin-json-spec](06-plugin-json-spec.md)) · normative clauses (→ the [00-readme](00-readme.md) index) |
...
**Which doc has the details**
[02-local-preview-environment.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/02-插件开发工具链/02-本地预览环境.md) — what the dev host is, why the author side needs zero configuration, and HMR's boundaries. This step **does not start the LinkDesk app**; it only runs the plugin's own preview host.
...
- 👉 [plugin-sdk README §API cheatsheet](https://github.com/Encaron/linkdesk/blob/electron/packages/plugin-sdk/README.md#api-速查表)
...
**Which doc has the details**
[04-author-real-machine-debug-loop.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/02-插件开发工具链/04-作者真机调试环.md) — how the real-machine loop automates "rebuild + write directly", and why changing the bundle of an installed plugin doesn't count as a hot update.
...
- The byte-level format spec inside the zip → [01-plugin-standalone-build/02-linkdesk-plugin-format-spec.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/01-插件独立构建/02-linkdesk-plugin格式规范.md)
...
**Which docs have the details**
- The full chain (local → GitHub → the user's machine) → [03-plugin-release-pipeline.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/02-插件开发工具链/03-插件发布流水线.md)
- The end-to-end journey from an author's perspective → [05-docs-and-release/00-third-party-author-journey.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/05-文档与发布/00-第三方作者旅程.md)
...
| After `npm run build` the installed plugin still behaves the old way | Installed plugins run the prebuilt bundle; source changes need a rebuild | Step 7 · [04-author-real-machine-debug-loop.md](https://github.com/Encaron/linkdesk/blob/electron/docs/02-Electron架构/E6_插件生态与发布/02-插件开发工具链/04-作者真机调试环.md) |
...
|---|---|
| **Know what APIs you can call** | [01-plugin-api-contract](01-plugin-api-contract.md) + [SDK README cheatsheet](https://github.com/Encaron/linkdesk/blob/electron/packages/plugin-sdk/README.md#api-速查表) |
