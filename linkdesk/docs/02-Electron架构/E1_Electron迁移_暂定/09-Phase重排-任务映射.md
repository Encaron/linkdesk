...
| 旧编号 | 旧内容 | 去向 | 原因 |
|---|---|---|---|
| **Phase 7b** | 文件树 + Monaco 编辑器 | → `02-Electron架构/E4_文件树与编辑器_暂定/` | 工厂插件（`core: true`）——不改变架构 |
| **Phase 8** | 卡片工作台 + OLED | → `04-未来规划/插件_工作台与OLED_暂定/` | 纯消费者插件——不改变架构 |
...
| `docs/02-Electron架构/E4_文件树与编辑器_暂定/` | **E4** | 第一批消费者插件——最后一批有 E 编号 |
| `docs/04-未来规划/插件_工作台与OLED_暂定/` | 插件 | 第二批消费者插件 |
