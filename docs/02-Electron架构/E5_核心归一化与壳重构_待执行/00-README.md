...
| 目录 | 内容 | 例子 |
|------|------|------|
| **04-出厂制造** | 马上能做的 UI 改进 | FloatingPanel 通用悬浮面板（#03） |（⚠️ 2026-09-13 重组：04-出厂制造 已拆并入 `docs/04-软件更新/` + `docs/05-插件更新/`，出厂批次概念退役）
| **05-版本更新** | E4 后的壳版本升级 | v1.2 终端系统、v1.3 可拖出标签页、v1.4 项目管理器 |（⚠️ 2026-09-13 重组：05-版本更新 已拆并入 `docs/04-软件更新/` + `docs/05-插件更新/`）
...
> **→ 下一 Phase：** `../../04-出厂制造/`（FloatingPanel / 终端系统 / 可拖出标签页）（⚠️ 2026-09-13 重组：04-出厂制造 已拆并入 `docs/04-软件更新/` + `docs/05-插件更新/`，出厂批次概念退役）
