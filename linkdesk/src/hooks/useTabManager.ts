...
import { resolveLegacyPluginId, isPluginDetailView } from "../core/utils/tabIdentity";

import { findGroup } from "./useTabManager/types";
import type { Tab, TabState, LayoutData, CloseTabResult } from "./useTabManager/types";
...
import { createInitialTabState, ensureFallback, createGroup, syncCountersAfterRestore, syncGroupCounterFromGroups } from "./useTabManager/defaults";
