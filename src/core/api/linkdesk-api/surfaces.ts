...
export type PoolExposed = Pick<LinkDeskAPI,
  ...
  pool: Pick<LinkDeskAPI["pool"], "onLayout" | "ready" | "sidebarAction" | "tabAction" | "tabBarRects" | "registerBeforeClose" | "unregisterBeforeClose" | "beforeClose">;
};
...
export type ShellExposed = Pick<LinkDeskAPI,
  ...
  pool: Omit<LinkDeskAPI["pool"], "onLayout" | "ready" | "sidebarAction" | "tabAction" | "tabBarRects" | "registerBeforeClose" | "unregisterBeforeClose" | "beforeClose">;
};
