...
> 🌐 **Chinese version（维护者面原文）→ [../03-插件制造/00-README.md](../03-插件制造/00-README.md)** — this English tree is the **author-facing primary**; the two trees mirror each other one-for-one (the `check-author-docs-bilingual` gate enforces it).
