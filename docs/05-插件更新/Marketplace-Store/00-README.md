# Marketplace Store（插件市场商店视图）

> **普通插件**——改 `plugins/marketplace/` 内部代码，不改壳，独立版本。旧「市场插件 / 出厂制造排序 5/11」标记作废（2026-09-13 重组）。
> 原「06-Plugin-Showcase-插件橱窗」已并入本档作一章（[03-插件橱窗.md](03-插件橱窗.md)）——它本是商店顶部的「编辑推荐」横幅组件，随本插件一起分发，不独立成插件。
