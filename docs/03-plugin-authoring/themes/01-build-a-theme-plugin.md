...
>
> **This page is the walkthrough** (I want to build a theme, so let's go from the top); the **deep reference for recipe fields** is in [11-Authoring Themes](../11-authoring-themes.md) (directory conventions / fully-specified example / pitfalls table), and the **index of fields and variables** is in [02-Theme Field Index](02-theme-field-index.md).
...
Publishing it to others (package → publish, two steps) follows **exactly the same** flow as any other plugin — see steps 8 and 9 of [13-Development Guide](../13-development-guide.md).
...
Method signatures and payloads → [01-Plugin API Contract](../01-plugin-api-contract.md).
...
| Recipe syntax deep reference (directory conventions / fully-specified example / full pitfalls table) | [11-Authoring Themes](../11-authoring-themes.md) |
| The complete path from scratch to publishing | [13-Development Guide](../13-development-guide.md) |
| I want to draw my own plugin icon / identity art | [06-plugin.json Spec](../06-plugin-json-spec.md) |
