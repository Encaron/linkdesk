...
import { findTabByIdentity, isSameTabIdentity, resolveLegacyPluginId, isPluginDetailView } from "../core/utils/tabIdentity";

import { allTabs, findGroup } from "./useTabManager/types";
import type { Tab, TabState, LayoutData, CreateTabResult, CloseTabResult } from "./useTabManager/types";
...
import { createTabDefaults, createInitialTabState, ensureFallback, pickNextActive, createGroup, syncCountersAfterRestore, syncGroupCounterFromGroups } from "./useTabManager/defaults";
