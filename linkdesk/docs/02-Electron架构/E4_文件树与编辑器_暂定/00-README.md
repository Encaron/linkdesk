...
| R2 | 🔴 CompactFolder 三合一 | E4V#4-E4V#6 +6a +Test2 | 0/5 | 🔴 先修 |
| R3 | 数据模型扩展 + 配置接线 | E4V#7-E4V#11 + E4V#8a | 0/6 | |
| R4 | 🔴 Context Key 解阻塞 | E4V#12-E4V#13 | 0/2 | 🔴 先修 |
| R5 | 剪贴板服务 | E4V#14 | 0/1 | |
| R6 | UI 对齐 VS Code | E4V#15-E4V#16 | 0/2 | |
| R7 | 简单命令 handler | E4V#17-E4V#19 | 0/3 | |
| R8 | 新建文件/文件夹 | E4V#20 + E4V#20+i–iv | 0/7 | |
...
| R14 | 集成 | E4V#32-E4V#33 | 0/2 | |
| R15 | Multi-root 工作区 | E4V#35-E4V#36 | 0/2 | |
| R16 | 文件搜索 | E4V#37-E4V#39 | 0/3 | |
| R17 | Monaco 编辑器 | E4V#40a–d + E4V#41a–b + E4V#42a–d | 0/10 | |
| R17.5 | 🛡️ vitest 防线 | E4V#Test1–Test5 | 1/5 | Test3 ✅ |
