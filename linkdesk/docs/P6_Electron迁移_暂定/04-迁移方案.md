...
> 2026-07-24。通查工程后定稿。**Phase 6 = 换地基。**
...
**Phase 5.5 修完 bug → Phase 6 迁移 → Phase 7 底层加固 → Phase 8 多 WebView 壳收尾 → 架构完工。**

```
Phase 5.5 剩余 bug 修复
    │
Phase 6: Electron 迁移（7 步，~16h AI）  ← 本文件夹
    │
Phase 7: 底层加固 + 侧栏扩展位  →  P7_底层加固与侧栏扩展_暂定/
    │
Phase 8: 多 WebView + 壳收尾    →  P8_多WebView与壳收尾_暂定/
    │                              🏁 架构完工
    ▼
