...
> 2026-07-22。小步快走——每步修完 → 立刻测 → 确认无误 → 下一步。
...
#### 步 7：F1 — 新增 `getTabCreatableViews` 统一过滤函数
...
#### 步 8：B4+E2 — 所有入口改用 `getTabCreatableViews`
