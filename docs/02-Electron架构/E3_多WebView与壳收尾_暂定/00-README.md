...
任务 ID 从 `#24` 到 `#68` + `#25a` + `#25b` + `#29a` + `#32a` + `#59a` + `#59b` + `#59c`，承接 E2 的 `#1`-`#23` + `#12a` + `#12b` + `#13a` + `#13b` + `#17a` + `#19a`-`#19l`（E2d #20-#23 已取消）。
...
> **🏁 E 编号到此为止。** E4 是最后一个编号——文件树 + Monaco 是第一批消费者插件，最后一批有 E 编号的任务（#64-#78）。此后全是插件。
