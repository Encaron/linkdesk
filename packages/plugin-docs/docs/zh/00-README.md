...
> 🌐 **English version（作者面主显）→ [../03-plugin-authoring/00-readme.md](https://github.com/Encaron/linkdesk/blob/electron/docs/03-plugin-authoring/00-readme.md)**——本中文树是**维护者面**；两棵树**篇篇对应**，改了一边必须同步另一边（门禁 `check-author-docs-bilingual` 盯着）。
